...
router.get("/analytics/links/:shortCode", analytics_controller_1.getLinkAnalytics);
router.get("/analytics/links/:shortCode/detailed", analytics_controller_1.getLinkDetailedAnalytics);
router.get("/analytics/overview/detailed", analytics_controller_1.getOverviewDetailedAnalytics);
